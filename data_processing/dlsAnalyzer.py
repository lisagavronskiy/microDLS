...
from data_processing.loadDLSdataHelpers import *
...
class dls_experiment:
    ...
    def __init__(self):
        ...
        self.temperature      = 298     # in K (20 degrees celsius)
    ...
    def loadWyatFile(self,file):
        ...
        self.lambda0         = 635 # in nm
        self.scatteringAngle = 90 / 180 * np.pi # radians
    ...
    def getInitialEstimates(self,alpha=0.1,timeLimit=1e9):
    ...
    def getInitialEstimatesManyAlpha(self,
        alphaVec=(5**np.arange(-6,2,0.1,dtype=float))**2,timeLimit=1e9):
    ...
    def getInitialEstimatesOptimalAlphaLcurve(self,timeLimit=1e9):
    ...
    def getWeightedInitialEstimates(self,alpha=0.15,timeLimit=1e9):
